...
public class socs {
	...
	//monto_de_overstock decimal(38,2) 
	//monto_de_po decimal(38,2) 
	private int no_de_proveedor;
	private int nooc;
	...
	public int getFoliott() {
		return foliott;
	}
	public void setFoliott(int foliott) {
	...
	public int getNo_de_proveedor() {
		return no_de_proveedor;
	}
	public void setNo_de_proveedor(int no_de_proveedor) {
